...
def isValidWord(word, hand, wordList):
    ...
    for letter in test:
        if hand.get(letter, 0) < test[letter]:
            return False
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            test = isValidWord(word, hand, wordList)
            ...
            # Otherwise (the word is valid):  
                ...
                earnScore = getWordScore(word, n)
                totalScore += earnScore
                print("\"{}\" earned {} points. Total: {} points".format(word,earnScore,totalScore))
                print()
    ...
    if calculateHandlen(hand) > 0:
        print("Goodbye! Total score: {} point.".format(totalScore))
        print()
    else:
